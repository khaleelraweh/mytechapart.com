...
<html
  ...
  <head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{ asset('frontend/vendor/libs/@form-validation/form-validation.css') }}" />
  ...
  <body>
    ...
    <script src="{{ asset('frontend/vendor/libs/hammer/hammer.js') }}"></script>

    <script src="{{ asset('frontend/vendor/libs/i18n/i18n.js') }}"></script>
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('frontend/vendor/libs/@form-validation/popular.js') }}"></script>
    <script src="{{ asset('frontend/vendor/libs/@form-validation/bootstrap5.js') }}"></script>
    <script src="{{ asset('frontend/vendor/libs/@form-validation/auto-focus.js') }}"></script>
    ...
    <!-- Page JS -->
    <script src="{{ asset('frontend/js/pages-auth.js') }}"></script>
  </body>
</html>
