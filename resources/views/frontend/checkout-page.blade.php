...
<html
  ...
  <head>
    ...
    <title>Demo: Checkout Card - Front Pages | Sneat - Bootstrap Dashboard PRO</title>
              ...
              <div id="checkout-confirmation" class="content">
                <div class="row mb-6">
                  <div class="col-12 col-lg-8 mx-auto text-center mb-2">
                    ...
                    <p>
                      <span
                        ><i class="icon-base bx bx-time-five me-1 text-heading align-top"></i> Time placed:&nbsp;</span
                      >
                      25/05/2020 13:35pm
                    </p>
                  </div>
                    ...
                    <ul class="list-group list-group-horizontal-md">
                      ...
                      <li class="list-group-item flex-fill p-6 text-body">
                        <h6 class="d-flex align-items-center gap-2">
                          <i class="icon-base bx bx-credit-card"></i> Billing Address
                        </h6>
                        <address class="mb-0">
                          John Doe <br />
                          4135 Parkway Street,<br />
                      ...
                      <li class="list-group-item flex-fill p-6 text-body">
                        <h6 class="d-flex align-items-center gap-2">
                          <i class="icon-base bx bxs-ship"></i> Shipping Method
                        </h6>
