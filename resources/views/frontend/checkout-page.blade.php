                ...
                <form id="addNewAddressForm" class="row g-6" onsubmit="return false">
                  ...
                  <div class="col-12">
                    ...
                    <select
                      ...
                      <option value="Australia">{{ __('checkout.australia') }}</option>
                      <option value="Bangladesh">{{ __('checkout.bangladesh') }}</option>
                      <option value="Belarus">{{ __('checkout.belarus') }}</option>
                      <option value="Brazil">{{ __('checkout.brazil') }}</option>
                      <option value="Canada">{{ __('checkout.canada') }}</option>
                      <option value="China">{{ __('checkout.china') }}</option>
                      <option value="France">{{ __('checkout.france') }}</option>
                      <option value="Germany">{{ __('checkout.germany') }}</option>
                      <option value="India">{{ __('checkout.india') }}</option>
                      <option value="Indonesia">{{ __('checkout.indonesia') }}</option>
                      <option value="Israel">{{ __('checkout.israel') }}</option>
                      <option value="Italy">{{ __('checkout.italy') }}</option>
                      <option value="Japan">{{ __('checkout.japan') }}</option>
                      <option value="Korea">{{ __('checkout.korea') }}</option>
                      <option value="Mexico">{{ __('checkout.mexico') }}</option>
                      <option value="Philippines">{{ __('checkout.philippines') }}</option>
                      <option value="Russia">{{ __('checkout.russia') }}</option>
                      <option value="South Africa">{{ __('checkout.south_africa') }}</option>
                      <option value="Thailand">{{ __('checkout.thailand') }}</option>
                      <option value="Turkey">{{ __('checkout.turkey') }}</option>
                      <option value="Ukraine">{{ __('checkout.ukraine') }}</option>
                      <option value="United Arab Emirates">{{ __('checkout.uae') }}</option>
                      <option value="United Kingdom">{{ __('checkout.uk') }}</option>
                      <option value="United States">{{ __('checkout.us') }}</option>
                    </select>
                  </div>
                  <div class="col-12">
